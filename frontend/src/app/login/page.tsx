      ...
      <div className="relative hidden w-1/2 overflow-hidden border-l border-white/10 bg-zinc-950 md:block">
        ...
        <div className="relative z-10 flex h-full flex-col justify-end p-12">
          <div className="max-w-[340px]">
            <h2 className="text-3xl font-bold leading-[1.1] tracking-tight">Coordination between enterprises and experts.</h2>
            <p className="mt-4 text-[13px] text-zinc-500">The platform for autonomous workforce allocation.</p>
          </div>
        </div>
